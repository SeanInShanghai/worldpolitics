...
<body data-mobile-url="/zh/mobile">
	...
	<div id="container" class="clearfix">
		<div id="teacher">
			<img class="teacher-img" src="<?php echo substr($teacher['mem_headPortrait'],18);?>" alt="教师1">
			<div id="teacher-info">
				<h1 class="teacher-name"><?php echo $teacher['mem_Name'];?></h1>
				<p class="teacher-title"><?php echo $teacher['mem_Alias'];?></p>
				<p class="teacher-contact"><?php echo $teacher['mem_Email'];?></br><br><?php echo $teacher['mem_HomePage'];?></p>
			</div>
