	...
	<div id="container" class="clearfix">
		<div id="column1">
			<div class="column-head" style="margin-top:15px;">
				...
				<a href="./artical_list.php?&&type=0"><b id="newest">最新文章</b></a>
				<span style="font-size:13px;color:#b9b9b9;">｜</span>
				<a href="./artical_list.php?&&type=1"><b id="hottest">最热文章</b></a>
			</div>
...
<div class="artical-latest">
   ...
   <div class="lastest-text">
		...
		<p class="latest-head">
			...
			<span style="font-size:13px;color:#b9b9b9;"> | <?php  echo date("Y年m月d日",$reLCArt['log_PostTime']);?></span>
		</p>
...
// 					$href = "tag_ID=".$tag_ID."&&action=moduleArts";
					...
					?>
					<a id="page<?php echo $i;?>" class="page-numbers" href="./artical_list.php?<?php echo $href?>&&type=<?php echo $type;?>"><?php echo $i?></a>
					<?php
					$href = '';
				}
						...
						<div class="clearfix">
						 <?php
							foreach ($members as $key => $value)
							{
								...
								<div class="label-background label-left">
								<a href="./teacher.php?<?php echo "id=".$value['mem_ID'];?>"><?php echo $value['mem_Name'];?></a>
							</div>
								<?php 
