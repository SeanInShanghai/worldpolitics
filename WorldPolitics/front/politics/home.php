				...
				<div class="box-border-content">
					<div id="popular-artical">
						...
						<ul class="popular-artical-title clearfix">
						       <?php 
						       foreach($rePopArt as $rePop){
								?>
                                      <li><a href="./artical.php?id=<?php echo $rePop['log_ID'];?>"><?php echo $rePop['log_Title'];?></a></li>
                                <?php 
                               }
						       ?>
...
// 						include 'getMemberlist.php';
						...
						<div class="clearfix">
							...
							<div class="professor professor-left">
 								<a href="./teacher.php?<?php echo "id=".$member['mem_ID'];?>">
  									<img width="70" height="70" src="<?php echo $member['mem_headPortrait'];?>" alt="教师1">
 			 					</a>
  								<a class="name" href="./teacher.php<?php echo "id=".$member['mem_ID'];?>"><?php echo $member['mem_Name'];?></a>
  							</div>	
								<?php 
								}else{
								?>
							<div class="professor">
							<a href="./teacher.php">
							<img width="70" height="70" src="<?php echo $member['mem_headPortrait'];?>" alt="教师3">
							</a>
